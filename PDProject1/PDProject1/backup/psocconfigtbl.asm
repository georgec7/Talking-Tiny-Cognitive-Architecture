...
;       Instance name PWM8_1, Block Name PWM8(DBC11)
	db		37h, 00h		;PWM8_1_CONTROL_REG(DBC11CR0)
	db		35h, ffh		;PWM8_1_PERIOD_REG(DBC11DR1)
	db		36h, 32h		;PWM8_1_COMPARE_REG(DBC11DR2)
;  Instance name Timer16_1, User Module Timer16
;       Instance name Timer16_1, Block Name TIMER16_LSB(DCC12)
	db		3bh, 00h		;Timer16_1_CONTROL_LSB_REG(DCC12CR0)
	db		39h, 00h		;Timer16_1_PERIOD_LSB_REG(DCC12DR1)
	db		3ah, 00h		;Timer16_1_COMPARE_LSB_REG(DCC12DR2)
;       Instance name Timer16_1, Block Name TIMER16_MSB(DCC13)
	db		3fh, 04h		;Timer16_1_CONTROL_MSB_REG(DCC13CR0)
	db		3dh, 00h		;Timer16_1_PERIOD_MSB_REG(DCC13DR1)
	db		3eh, 00h		;Timer16_1_COMPARE_MSB_REG(DCC13DR2)
...
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBC11)
	db		37h, 00h		;PWM8_1_(DBC11CR1)
	db		34h, 31h		;PWM8_1_FUNC_REG(DBC11FN)
	db		35h, 11h		;PWM8_1_INPUT_REG(DBC11IN)
	db		36h, 44h		;PWM8_1_OUTPUT_REG(DBC11OU)
;  Instance name Timer16_1, User Module Timer16
;       Instance name Timer16_1, Block Name TIMER16_LSB(DCC12)
	db		3bh, 00h		;Timer16_1_(DCC12CR1)
	db		38h, 00h		;Timer16_1_FUNC_LSB_REG(DCC12FN)
	db		39h, 01h		;Timer16_1_INPUT_LSB_REG(DCC12IN)
	db		3ah, 00h		;Timer16_1_OUTPUT_LSB_REG(DCC12OU)
;       Instance name Timer16_1, Block Name TIMER16_MSB(DCC13)
	db		3fh, 00h		;Timer16_1_(DCC13CR1)
	db		3ch, 20h		;Timer16_1_FUNC_MSB_REG(DCC13FN)
	db		3dh, 31h		;Timer16_1_INPUT_MSB_REG(DCC13IN)
	db		3eh, 00h		;Timer16_1_OUTPUT_MSB_REG(DCC13OU)
